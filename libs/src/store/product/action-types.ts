...
export const DOWNLOAD_PRODUCT_UPLOAD_TEMPLATE = createActionTypes('DOWNLOAD_PRODUCT_UPLOAD_TEMPLATE');
export const UPLOAD_PRODUCT_PRICING_REVISION = createActionTypes('UPLOAD_PRODUCT_PRICING_REVISION');
export const FETCH_PRODUCT_UPLOAD_LOGS = createActionTypes('FETCH_PRODUCT_UPLOAD_LOGS');
export const FETCH_CATEGORIES_BY_TYPE = createActionTypes('FETCH_CATEGORIES_BY_TYPE');
export const FETCH_MODEL_BY_CATEGORY = createActionTypes('FETCH_MODEL_BY_CATEGORY');
...
export const CLEAR_PRODUCT_UPLOAD_LOGS = 'CLEAR_PRODUCT_UPLOAD_LOGS';
export const CLEAR_UPLOAD_PRODUCTS_ERRORS = 'CLEAR_UPLOAD_PRODUCTS_ERRORS';
